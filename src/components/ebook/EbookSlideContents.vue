  ...
  <div class="ebook-slide-contents">
    ...
    <div class="slide-contents-book-wrapper">
      <div class="slide-contents-book-img-wrapper">
        <img :src="getCover" class="slide-contents-book-img">
      </div>
      <div class="slide-contents-book-info-wrapper">
        <div class="slide-contents-book-title">
          <span class="slide-contents-book-title-text">{{getMetadata.title}}</span>
        </div>
        <div class="slide-contents-book-author">
          <span class="slide-contents-book-author-text">{{getMetadata.creator}}</span>
        </div>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      doSearch(q) {
        return Promise.all(
          this.getCurrentBook.spine.spineItems.map(section => section.load(this.getCurrentBook.load.bind(this.getCurrentBook))
      ...
      // 是否缩进需要根据目录的的level来定，所以这里使用 px2rem方法动态生成，并且需要给定单位
    ...
    .slide-contents-book-wrapper {
      ...
      .slide-contents-book-info-wrapper {
        ...
        .slide-contents-book-author {
          // 153.75 = 375 * 0.85 - 30 = 288.75 再减去其它边距
          // width: px2rem(153.75);
          font-size: px2rem(12);
